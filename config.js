...
const CONFIG = {
    ...
    colors: {
        backgroundStart: "#CD2C58",      // Gradient start (try pastel colors for a soft look)
        backgroundEnd: "#E06B80",        // Gradient end (should complement backgroundStart)
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dwtmwgloq/video/upload/v1770450094/My_Love_Will_Never_Die_r5jpzn.mp3", // Music streaming URL
